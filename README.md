...
To download, either copy the text in this file to a bookmark or add this as a Tampermonkey script. Once you have done that, wear either a poofy or bulky diaper (either the panties or chastity version, or both if you want more potential uses!) and type ->diaper start in chat. Once you're done using it, type ->diaper stop to become contienent again.
